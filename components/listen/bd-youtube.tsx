    ...
    >
      ...
      >
        <HStack>
          ...
          <Image
            src='/images/youtube-logo-sm.png'
        ...
        <Text
          ...
          textAlign={'left'}
        >
          The official BanklessDAO youtube channel where you can find our:
          <UnorderedList
      ...
      <HStack justifyContent='center' alignItems='center' rowGap='2rem'>
        <Box
