  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          The Rug is the premiere crypto-satire brand in Web3. Subscribe to our
          newsletter for the hardest hitting articles and headlines. We take
          money, seriously.
        </Text>
        <Stack
          ...
          spacing={'12px'}
        >
          <Link href='https://www.therugnews.com' isExternal>
            <Flex
              align={'center'}
              color={'white.100'}
              fontSize='20px'
