      ...
      >
        ...
        >
          ...
          <Image
            ...
            borderRadius='50%'
            src={'/bankless-website/public/images/about-image-orbit-outer-3.png'}
          />
          <Image
            alt='orbit'
            position={'absolute'}
            ...
            borderRadius='50%'
            src={'/bankless-website/public/images/about-image-orbit-outer-1.png'}
          />
          <Image
            alt='orbit'
            position={'absolute'}
            ...
            borderRadius='50%'
            src={'/bankless-website/public/images/about-image-orbit-outer-2.png'}
          />
          <Image
            alt='orbit'
            position={'absolute'}
            ...
            borderRadius='50%'
            src={'/bankless-website/public/images/about-image-orbit-mid-1.png'}
          />
          <Image
            alt='orbit'
            position={'absolute'}
            ...
            borderRadius='50%'
            src={'/bankless-website/public/images/about-image-orbit-mid-2.png'}
          />
          <Image
            alt='orbit'
            position={'absolute'}
            ...
            borderRadius='50%'
            src={'/bankless-website/public/images/about-image-orbit-mid-3.png'}
          />
          <Box
            position={'absolute'}
