      ...
      >
        <Box align={"center"}>
            ...
            <Box
              ...
              backdropBlur="5px"
            />
            <Text width={["100%","50%"]} color="white.900" align={"center"}>We work to build a world where anyone with an internet connection has access to the tools needed to achieve financial independence. We want everyone to be able to open a computer, find a DAO, start working, and get paid. We want to enable visionaries to unlock their true creative freedom with the power of Web3.</Text>
        </Box>
      </Flex>
    )
  }
